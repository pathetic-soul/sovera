...
| Test suite | **251 passed, 1 deliberate xfail** | `pytest -q` |
| Type checking | **mypy strict, clean, 54 files** | includes the largest module |
...
| Token spend, full demo | 4–6k (cap now 1,000,000) | measured |
