...
| **R6** | Doc drift. AGENTS.md §16 still records router accuracy as 75.8% with the encoder undecided; both are stale. README carried a stale test count until today. | 4 | 2 | 8 | Contain | Quote `gates.py`, never a hand-typed number. Refresh §16. |
...
├─ tests/               184 tests, 1 deliberate xfail
